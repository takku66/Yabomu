...
class Todolist {
	...
	constructor(todoArea, cardTemplate){
		...
		this._list = document.querySelectorAll(".todo-box");
		this._map = {};
		for(let todoBox of list){
			let todoId = todoBox.querySelector(".todo-id").value;
			this._map[todoId] = todoBox;
		}
	}
...
const TODO = {
	...
	configureEventOpenEditTodo: function(){
		for(let elm of this.todolistMap){
